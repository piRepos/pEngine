...
namespace pEngine.Utils.Extensions
{
    static class ListExtensions
    {
		...
		/// <summary>
		/// Returns each element which reach the specified condition removing it.
		/// </summary>
		/// <typeparam name="T">Element type.</typeparam>
		/// <param name="data">The list to take values.</param>
		/// <param name="predicate">The predicate which matches the items.</param>
		/// <returns>A collection of removed items.</returns>
		public static IEnumerable<T> TakeAll<T>(this List<T> data, Func<T, bool> predicate)
		{
